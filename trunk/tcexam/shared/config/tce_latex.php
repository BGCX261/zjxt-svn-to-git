 ...
 */
define ('K_LATEX_PATH_LATEX', 'E:/Progra~1/CTEX/MiKTeX/miktex/bin/latex.exe');

/**
 * Path to DVIPS (/usr/bin/dvips).
 */
define ('K_LATEX_PATH_DVIPS', 'E:/Progra~1/CTEX/MiKTeX/miktex/bin/dvips.exe');

/**
 * Path to ImageMagick convert (/usr/bin/convert).
 */
define ('K_LATEX_PATH_CONVERT', 'C:\PROGRA~1\ImageMagick-6.7.2-Q16/convert.exe');

/**
 * Path to ImageMagick identify (/usr/bin/identify).
 */
define ('K_LATEX_PATH_IDENTIFY', 'C:\PROGRA~1\ImageMagick-6.7.2-Q16/identify.exe');
