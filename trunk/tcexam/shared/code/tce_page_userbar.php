...
echo '<div class="colorbutton"><span class="colorselector" style="background-color:#039" onclick="setCookie(\'tc_color\',0);window.location.reload();"></span><span class="colorselector" style="background-color:#f40" onclick="setCookie(\'tc_color\',1);window.location.reload();"></span></div>';
echo '<div class="minibutton" dir="ltr">';
echo '<span class="copyright"><a href="http://www.ces.shu.edu.cn/"> ver. '.K_TCEXAM_VERSION.' - Copyright &copy; 2011 上海大学计算机工程与科学学院</a></span>';
echo '</div>'.K_NEWLINE;
// Display W3C logos
echo '<div class="minibutton" dir="ltr">'.K_NEWLINE;
