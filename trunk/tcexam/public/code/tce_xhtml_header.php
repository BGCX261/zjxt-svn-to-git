...
$color = (int)@$_COOKIE['tc_color'];
$thispage_style = $color==0?($thispage_style.".css"):($thispage_style."_".$color.".css");
...
echo '<link href="../../scripts/jquery-ui-1.8rc1.custom.css" rel="stylesheet" type="text/css"/>'.K_NEWLINE;
echo '<script src="../../scripts/jquery-1.5.1.min.js"></script>'.K_NEWLINE;
echo '<script src="../../scripts/jquery.ui.core.js"></script>'.K_NEWLINE;
echo '<script src="../../scripts/jquery.ui.widget.js"></script>'.K_NEWLINE;
echo '<script src="../../scripts/jquery.ui.tabs.min.js"></script>'.K_NEWLINE;
echo '<script src="../../scripts/jquery.ui.datepicker.js"></script>'.K_NEWLINE;
