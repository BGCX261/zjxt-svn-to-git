...
echo '<div style="border:1px solid black; padding:5px; margin:10px; background-color:#DDEEFF; color:#000000; width:95%; margin-left:auto; margin-right:auto; font-weight:bold; font-size:95%;">TCEXAM 遵循 <a href="http://www.fsf.org/licensing/licenses/agpl-3.0.html" title="">GNU-AGPL v.3 .</a></div>'.K_NEWLINE;
