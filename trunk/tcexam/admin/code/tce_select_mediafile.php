...
if (!empty($file)) {
	...
	echo '<br /><a href="javascript:;" onclick="window.open(\'../../shared/flash/\',\'painter\',\'height=610,width=824,resizable=no,menubar=no,scrollbars=no,toolbar=no,directories=no,status=no\');">'.@$l['w_paint'].'</a>'.K_NEWLINE;
}
echo '</fieldset>'.K_NEWLINE;
